...
class JpaDeviceRepositoryIT extends RepositoryIT {
	...
	void shouldSetCreatedAtAndUpdatedAtOnCreate() {
		...
		var device = new Device("TimestampTest", "Test device");
	...
	void shouldUpdateUpdatedAtOnModification() throws InterruptedException {
		var device = new Device("UpdateTimestampTest", "Test device");
		Device savedDevice = deviceRepository.save(device);
	...
	void shouldPreserveTimestampsOnRead() {
		var device = new Device("ReadTimestampTest", "Test device");
		Device savedDevice = deviceRepository.save(device);
	...
	@Test
	void shouldHaveEmptySensorsListInitially() {
		var device = new Device("EmptySensorList", "Device with no sensors");
		Device savedDevice = deviceRepository.save(device);

		assertThat(savedDevice.getSensors()).isEmpty();
	}
}