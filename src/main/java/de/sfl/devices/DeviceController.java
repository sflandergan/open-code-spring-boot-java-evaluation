...
public class DeviceController {
	...
	public ResponseEntity<DeviceDto> updateDevice(@PathVariable UUID deviceId, @Valid @RequestBody UpdateDeviceDto updateDeviceDto) {
	...
	@Operation(summary = "Delete a device", description = "Deletes a device and all sensor assignments")
	@ApiResponses(value = {
	...
	private DeviceDto toDto(Device device) {
		var sensorIds = deviceService.getDeviceSensors(device.getId());
