...
public class DeviceController {
	...
	@PutMapping("/{id}")
	@Operation(summary = "Update an existing device", description = "Updates the provided device fields")
	@ApiResponses(value = {
	...
	@DeleteMapping("/{id}")
	@Operation(summary = "Delete a device", description = "Deletes a device and all related sensor assignments")
	@ApiResponses(value = {
	...
	@Operation(summary = "Assign sensor to device", description = "Assigns an existing sensor to a device idempotently")
	@ApiResponses(value = {
